                    ...
                    AlertDialog dialog = builder.setTitle("Capture Signature")
                            ...
                            .setPositiveButton("Ok, Proceed", new DialogInterface.OnClickListener() {
                                ...
                                public void onClick(DialogInterface dialogInterface, int i) {
                                    ...
                                    if (ContextCompat.checkSelfPermission(AddCoSignerActivity.this, Manifest.permission.CAMERA)
                                            == PackageManager.PERMISSION_DENIED) {
                                        captureImageThroughCamera("Signature");
                                    } else {
                                        ActivityCompat.requestPermissions(AddCoSignerActivity.this, new String[]{Manifest.permission.CAMERA}, REQUEST_CAMERA_CODE_FOR_SIGNATURE);
                                    }
                                }
                            })
                            ...
                            switch (which) {
                                case DialogInterface.BUTTON_POSITIVE:
                                    ...
                                    if (ContextCompat.checkSelfPermission(AddCoSignerActivity.this, Manifest.permission.CAMERA)
                                        ...
                                        ActivityCompat.requestPermissions(AddCoSignerActivity.this, new String[] {Manifest.permission.CAMERA}, REQUEST_CAMERA_CODE_FOR_INITIAL);
                                    }
                                    break;
